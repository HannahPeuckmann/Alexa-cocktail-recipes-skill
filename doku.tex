...
\lstinputlisting[language=Python, firstline=62, lastline=108]{dm_projekt_flask.py}
...
\lstinputlisting[language=Python, firstline=310, lastline=338]{dm_projekt_flask.py}
...
\lstinputlisting[language=Python, firstline=341, lastline=378]{dm_projekt_flask.py}
...
\lstinputlisting[language=Python, firstline=223, lastline=263]{dm_projekt_flask.py}
...
\lstinputlisting[language=Python, firstline=266, lastline=307]{dm_projekt_flask.py}
...
\lstinputlisting[language=Python, firstline=179, lastline=220]{dm_projekt_flask.py}
...
\lstinputlisting[language=Python, firstline=111, lastline=176]{dm_projekt_flask.py}
...
\lstinputlisting[language=Python, firstline=381, lastline=415]{dm_projekt_flask.py}
...
\lstinputlisting[language=Python, firstline=418, lastline=430]{dm_projekt_flask.py}
...
\lstinputlisting[language=Python, firstline=433, lastline=449]{dm_projekt_flask.py}
...
\lstinputlisting[language=Python, firstline=26, lastline=37]{basic_handlers.py}

\subsubsection{CancelIntent, StopIntent}
Die Built-in Intent AMAZON.Cancel und AMAZON.Stop dienen zum Beenden des Skills. \\
\lstinputlisting[language=Python, firstline=40, lastline=52]{basic_handlers.py}
...
\lstinputlisting[language=Python, firstline=55, lastline=70]{basic_handlers.py}
